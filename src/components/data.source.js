  ...
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        children:
          "We help You to Discover the best Digital Solution that Supports You and Your Business with Web and Mobile Applications Development",
      },
      {
        name: "button1",
    ...
    children: [
      {
        ...
        children: {
          ...
          children: [
            ...
            {
              name: "content",
              children: "We help you accelerate the digital transformation",
            },
          ],
        },
      },
        ...
        children: {
          ...
          children: [
            ...
            },
            {
              name: "content",
              children:
                "Customised design, integrated with cutting edge technologies",
            },
          ],
        },
      },
    ...
    children: [
      {
        ...
        children: {
          ...
          content: {
            ...
            children: "Build your shops online",
          },
        },
      },
      {
      ...
      },
      {
        ...
        children: {
          ...
          title: {
            className: "content3-title",
            children: "Human Resources & Workforce",
          },
          content: {
            className: "content3-content",
            children:
      ...
      },
      {
        ...
        children: {
          ...
          title: {
            className: "content3-title",
            children: "Customised Solution",
          },
          content: {
            className: "content3-content",
            children: "Want something special, we can help you out",
          },
        },
      },
      {
...
export const BookDataSource = {
  ...
  titleWrapper: {
    ...
    children: [
      ...
      {
        name: "title",
        children: "Book a Consultation Today",
        className: "title-h1",
      },
      {
        name: "content",
        children: "Our experts will help you find out the best",
        className: "title-content",
      },
      {
        name: "content2",
  ...
  button: {
    className: "",
    children: {
      a: { className: "button", href: "/contact", children: "Book" },
    },
  },
};
...
export const SEODataSource = {
  ...
  description:
    "Ok Sysytems, a new startup focused on web development, we know this better",
  keywords:
    "Ok Systems, Melbourne Web Development, Chinese Web Development, Melbourne IT solutions",
  twitter: {
    label1: "Reading time",
    data1: "why you care?",
  },
